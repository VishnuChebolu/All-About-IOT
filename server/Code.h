    ...
    <div class="NotPopup">
        ...
        <ul class="flex-container">
            ...
            <li class="flex-item">
                ...
                <div class="slideThree">
                    <input type="checkbox" value="None" id="slideThree3" onchange="checkbox()" name="check" checked />
            ...
            <li class="flex-item">
                ...
                <div class="slideThree">
                    <input type="checkbox" value="None" id="slideThree5" onchange="checkbox()" name="check" checked />
            ...
            <!-- <li class="flex-item">
                ...
                <div class="slideThree">
                    <input type="checkbox" value="None" id="slideThree7" onchange="checkbox()" name="check" checked />
...
<div class="slideThree">
    <input type="checkbox" value="None" id="slideThree8" onchange="checkbox()" name="check" />
...
var option8 = document.getElementById("slideThree8");

function checkbox(){
  
  if(option1.checked){
    localStorage.setItem("PIN1",11);
    send(11);
  }
  else if(!option1.checked){
    localStorage.setItem("PIN1",10);
    send(10);
  }
  if(option2.checked){
    localStorage.setItem("PIN2",21);
    send(21);
  }
  else if(!option2.checked){
    localStorage.setItem("PIN2",20);
    send(20);
  }
  if(option3.checked){
    localStorage.setItem("PIN3",31);
    send(31);
  }
  else if(!option3.checked){
    localStorage.setItem("PIN3",30);
    send(30);
  }
  if(option4.checked){
    localStorage.setItem("PIN4",41);
    send(41);
  }
  else if(!option4.checked){
    localStorage.setItem("PIN4",40);
    send(40);
  }
  if(option5.checked){
    localStorage.setItem("PIN5",51);
    send(51);
  }
  else if(!option5.checked){
    localStorage.setItem("PIN5",50);
    send(50);
  }
  if(option6.checked){
    localStorage.setItem("PIN6",61);
    send(61);
  }
  else if(!option6.checked){
    localStorage.setItem("PIN6",60);
    send(60);
  }
  if(option7.checked){
    localStorage.setItem("PIN7",71);
    send(71);
  }
  else if(!option7.checked){
    localStorage.setItem("PIN7",70);
    send(70);
  }
  if(option8.checked){
    localStorage.setItem("PIN8",81);
    send(81);
  }
  else if(!option8.checked){
    localStorage.setItem("PIN8",80);
    send(80);
  }
...
function getcheck(){
          let value1 = localStorage.getItem("PIN1");
          let value2 = localStorage.getItem("PIN2");
          let value3 = localStorage.getItem("PIN3");
          let value4 = localStorage.getItem("PIN4");
          let value5 = localStorage.getItem("PIN5");
          let value6 = localStorage.getItem("PIN6");
          let value7 = localStorage.getItem("PIN7");
          let value8 = localStorage.getItem("PIN8");
        if(value1 == 11){
