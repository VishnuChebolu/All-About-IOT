...
const char* ssid     = "Bhavani";//Replace with your Wifi Name
const char* password = "bhavani1234";// Replace with your wifi Password

//change your channel number here
unsigned long channel =1526741;//Replace with your own ThingSpeak Account Channle ID
